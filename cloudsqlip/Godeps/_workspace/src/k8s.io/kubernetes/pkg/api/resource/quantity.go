...
import (
	...
	flag "github.com/jordic/k8s/cloudsqlip/Godeps/_workspace/src/github.com/spf13/pflag"
	"github.com/jordic/k8s/cloudsqlip/Godeps/_workspace/src/speter.net/go/exp/math/dec/inf"
)
