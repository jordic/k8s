...
import (
	...
	"github.com/jordic/k8s/cloudsqlip/Godeps/_workspace/src/golang.org/x/net/context"
	"github.com/jordic/k8s/cloudsqlip/Godeps/_workspace/src/k8s.io/kubernetes/pkg/auth/user"
)
