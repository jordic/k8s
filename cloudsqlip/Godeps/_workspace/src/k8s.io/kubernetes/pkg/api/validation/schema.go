...
import (
	...
	"github.com/jordic/k8s/cloudsqlip/Godeps/_workspace/src/github.com/emicklei/go-restful/swagger"
	...
	"github.com/jordic/k8s/cloudsqlip/Godeps/_workspace/src/k8s.io/kubernetes/pkg/util/yaml"
)
