...
import (
	...
	pkg4_resource "github.com/jordic/k8s/cloudsqlip/Godeps/_workspace/src/k8s.io/kubernetes/pkg/api/resource"
	pkg1_unversioned "github.com/jordic/k8s/cloudsqlip/Godeps/_workspace/src/k8s.io/kubernetes/pkg/api/unversioned"
	pkg2_v1 "github.com/jordic/k8s/cloudsqlip/Godeps/_workspace/src/k8s.io/kubernetes/pkg/api/v1"
	pkg3_types "github.com/jordic/k8s/cloudsqlip/Godeps/_workspace/src/k8s.io/kubernetes/pkg/types"
	pkg6_intstr "github.com/jordic/k8s/cloudsqlip/Godeps/_workspace/src/k8s.io/kubernetes/pkg/util/intstr"
	pkg5_inf "github.com/jordic/k8s/cloudsqlip/Godeps/_workspace/src/speter.net/go/exp/math/dec/inf"
	"reflect"
	"runtime"
	time "time"
)
