...
import (
	...
	"github.com/jordic/k8s/cloudsqlip/Godeps/_workspace/src/github.com/ghodss/yaml"
	"github.com/jordic/k8s/cloudsqlip/Godeps/_workspace/src/github.com/golang/glog"

	clientcmdapi "github.com/jordic/k8s/cloudsqlip/Godeps/_workspace/src/k8s.io/kubernetes/pkg/client/unversioned/clientcmd/api"
	clientcmdlatest "github.com/jordic/k8s/cloudsqlip/Godeps/_workspace/src/k8s.io/kubernetes/pkg/client/unversioned/clientcmd/api/latest"
	utilerrors "github.com/jordic/k8s/cloudsqlip/Godeps/_workspace/src/k8s.io/kubernetes/pkg/util/errors"
)
