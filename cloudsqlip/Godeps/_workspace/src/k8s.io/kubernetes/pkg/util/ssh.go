...
import (
	...
	"github.com/jordic/k8s/cloudsqlip/Godeps/_workspace/src/github.com/prometheus/client_golang/prometheus"
	"github.com/jordic/k8s/cloudsqlip/Godeps/_workspace/src/golang.org/x/crypto/ssh"
)
